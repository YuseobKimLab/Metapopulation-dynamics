...
void Replicate( vtype *parent, vtype *child )
{
	int dm, loc;
...
void Recombination(vtype *vrs1, vtype *vrs2){
        int locrc, i;
        unsigned int *temp;
...
// Now it only copy first and second segments
{
		...
		for (dm2=0; dm2<Ndeme; dm2++)
		{
			if (dm != dm2)
			{
				...
				for (j=0; j<nmig; j++)
				{
					...
					for (loc=0; loc<nNonsy; loc++)
						vrs[dm2][nchr[dm2]].AA2[loc] = vrs[dm][mchr].AA2[loc];
					for (loc=0; loc<nSynon; loc++)
						vrs[dm2][nchr[dm2]].Sy2[loc] = vrs[dm][mchr].Sy2[loc];
					...
					vrs[dm2][nchr[dm2]].numDel1 = vrs[dm][nchr[dm]].numDel1;
					vrs[dm2][nchr[dm2]].numDel2 = vrs[dm][nchr[dm]].numDel2;
					...
					for(loc=0; loc<nNonsy; loc++)
						vrs[dm][mchr].AA2[loc] = vrs[dm][nchr[dm]-1].AA2[loc];
					for (loc=0; loc<nSynon; loc++)
						vrs[dm][mchr].Sy2[loc] = vrs[dm][nchr[dm]-1].Sy2[loc];
					...
					vrs[dm][mchr].numDel1 = vrs[dm][nchr[dm]-1].numDel1;
					vrs[dm][mchr].numDel2 = vrs[dm][nchr[dm]-1].numDel2;
